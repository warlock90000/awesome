...
local fd_async = require("util.fd_async")
...
local categories = {
  AudioVideo ={icon="applications-multimedia" ,name="Multimedia"  },
  Development={icon="applications-development",name="Development" },
  Education  ={icon="applications-science"    ,name="Education"   },
  Game       ={icon="applications-games"      ,name="Games"       },
  Graphics   ={icon="applications-graphics"   ,name="Graphics"    },
  Network    ={icon="applications-internet"   ,name="Internet"    },
  WebBrowser ={icon="applications-internet"   ,name="WebBrowser"  },
  Office     ={icon="applications-office"     ,name="Office"      },
  Settings   ={icon="preferences-desktop"     ,name="Settings"    },
  System     ={icon="applications-system"     ,name="System Tools"},
  Utility    ={icon="applications-accessories",name="Accessories" },
              ...
              if not parent._internal.categories_menu[category] then
                ...
                m:connect_signal("visible::changed",function()
                  for k,ini in ipairs(m._internal.entries) do
                    if not ini.NoDisplay then ---- если нет метки NoDisplay
