...
local function worker(format, warg)
    if not warg then return "dasdasdasda" end

    -- Get weather forceast using the city ID code, from:
    -- * OpenWeatherMap.org
    local openweather = "http://api.openweathermap.org/data/2.5/weather?id="..warg.."&appid=3e321f9414eaedbfab34983bda77a66e&units=metric"
